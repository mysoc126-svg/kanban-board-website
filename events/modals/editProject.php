    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="lead text-primary" ><?php echo $l_edit_project;?></h3>
            ...
            <form name="project" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST" role="form">
                <div class="modal-body">				
                    <div class="form-group">
                        <label class="text-dark" for="edit_name"><?php echo $l_name_project;?><span class="text-danger pl-1">*</span></label>
					...
					<div class="form-group">
						<label for="edit_colour" class="text-dark"><?php echo $l_color;?></label>
                        ...
                        <?php 
                         if($p['project_colour'] == '#0275d8') {echo $l_Blue;} 
                         elseif ($p['project_colour'] == '#5bc0de') {echo $l_Tile;} 
                         elseif ($p['project_colour'] == '#5cb85c') {echo $l_Green;} 
                         elseif ($p['project_colour'] == '#f0ad4e') {echo $l_Orange;} 
                         elseif ($p['project_colour'] == '#d9534f') {echo $l_Red;} 
                         elseif ($p['project_colour'] == '#292b2c') {echo $l_Black;} 
                         else { echo ""; } ?>                      
							...
							<option style="color:#292b2c" value="#292b2c">&#9724; <?php echo $Черный;?></option>						  
						</select>
				    </div>          

                <div class="form-group d-flex justify-content-between mt-2">
                    <div class="col-6 mt-0 p-1">                        
                        <label class="text-dark"><?php echo $l_start_date_add;?><span class="text-danger pl-1">*</span></label>
                    ...
                    <div class="col-6 m-0 p-1">  
                        <label class="text-dark"><?php echo $l_end_date_add;?><span class="text-danger pl-1">*</span></label>
